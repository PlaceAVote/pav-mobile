...
class Profile extends Component {
  ...
  onFollowBtnPress(e){
    ...
    if(this.props.profile.form.profileData.currentlyFollowingUser){
      this.props.actions.unfollowUser(this.props.auth.form.user.id);//,null, false);//, token)
    }else{
      this.props.actions.followUser(this.props.auth.form.user.id);//,null, false);//, token)
    }
