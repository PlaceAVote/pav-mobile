...
module.exports =  {
  ...
  TOPICS:{
    CRIME:{title: 'Crime', key: 'CRIME', img: require('../../assets/crimeTopic.png'), tag:'crime'},
    HEALTHCARE:{title: 'Healthcare', key: 'HEALTHCARE', img: require('../../assets/healthcareTopic.png'), tag:'healthcare'},
    TAXES:{title: 'Taxes', key: 'TAXES', img: require('../../assets/taxesTopic.png'), tag:'taxes'},
    IMMIGRATION:{title: 'Immigration', key: 'IMMIGRATION', img: require('../../assets/immigrationTopic.png'), tag:'immigration'},
    EDUCATION:{title: 'Education', key: 'EDUCATION', img: require('../../assets/educationTopic.png'), tag:'education'},
    DRUGS:{title: 'Drugs', key: 'DRUGS', img: require('../../assets/drugsTopic.png'), tag:'drugs'},
    DEFENSE:{title: 'Defense', key: 'DEFENSE', img: require('../../assets/defenseTopic.png'), tag:'defense'},
    POLITICS:{title: 'Politics', key: 'POLITICS', img: require('../../assets/politicsTopic.png'), tag:'politics'},
    GUN_RIGHTS:{title: 'Gun Rights', key: 'GUN_RIGHTS', img: require('../../assets/gunsTopic.png'), tag:'gun'},
    TECHNOLOGY:{title: 'Technology', key: 'TECHNOLOGY', img: require('../../assets/technologyTopic.png'), tag:'technology'},
    ECONOMICS:{title: 'Economics', key: 'ECONOMICS', img: require('../../assets/economicsTopic.png'), tag:'economics'},
    SOCIAL_INTEREST:{title: 'Social Interest', key: 'SOCIAL_INTEREST', img: require('../../assets/socialTopic.png'), tag:'social'},
  },
  ...
  ActionNames:  keyMirror({
   ...
   GET_TRENDING_REQUEST: null,
   GET_TRENDING_SUCCESS: null,
   GET_TRENDING_FAILURE: null,
