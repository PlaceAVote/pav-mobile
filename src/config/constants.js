...
module.exports =  {
  ...
  TOPICS:{
    CRIME:{title: 'Crime', key: 'CRIME', img: require('../../assets/crimeTopic.png')},
    HEALTHCARE:{title: 'Healthcare', key: 'HEALTHCARE', img: require('../../assets/healthcareTopic.png')},
    TAXES:{title: 'Taxes', key: 'TAXES', img: require('../../assets/taxesTopic.png')},
    IMMIGRATION:{title: 'Immigration', key: 'IMMIGRATION', img: require('../../assets/immigrationTopic.png')},
    EDUCATION:{title: 'Education', key: 'EDUCATION', img: require('../../assets/educationTopic.png')},
    DRUGS:{title: 'Drugs', key: 'DRUGS', img: require('../../assets/drugsTopic.png')},
    DEFENSE:{title: 'Defense', key: 'DEFENSE', img: require('../../assets/defenseTopic.png')},
    POLITICS:{title: 'Politics', key: 'POLITICS', img: require('../../assets/politicsTopic.png')},
    GUN_RIGHTS:{title: 'Gun Rights', key: 'GUN_RIGHTS', img: require('../../assets/gunsTopic.png')},
    TECHNOLOGY:{title: 'Technology', key: 'TECHNOLOGY', img: require('../../assets/technologyTopic.png')},
